...
<div class="box">
  <div class="box-header">
    <div class="center-all">
      <h1> Đăng nhập </h1>
      <p class="lead"> Shop quần áo số 1 Việt Nam </p>
      <p class="text-muted"> 
        Shop chuyên bán các loại quần áo cho giới trẻ, thời thượng, năng động, streetwear,....
      </p>
    </div>
  </div>
  ...
  <div class="center-all" style="width:20%;display:flex;">
    <a href="admin_area/index.php" target="_blank">
...
<?php 
  ...
  if(isset($_POST['login'])) {
    ...
    if($check_customer == 0 ) {
      echo "<script>alert('Email hoặc mật khẩu của bạn đã sai!');</script>";
      exit();
    }
