...
if(isset($_POST['update'])){
    ...
    if(is_uploaded_file($_FILES['file']['tmp_name'])){
            ...
            // Hoạt động khi upload/update ảnh
        ...
        // Hoạt động khi không cập nhật ảnh
        
        $update_product = "update product set p_cat_id='$product_cat',cat_id='$cat',manufacturer_id='$manufacturer_id',date=NOW(),product_title='$product_title',product_keywords='$product_keywords',product_desc='$product_desc',product_price='$product_price' where product_id='$p_id'";
